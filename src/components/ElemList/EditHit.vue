<template>
  <div>
    <el-input type="textarea" v-model="currentValue" v-show="isEdit" class="edit-input" size="small" @blur="handleRowChange" :rows="rows" />
    <span v-show="isEdit">{{ scope.row[item.prop] }}</span>
  </div>
</template>
